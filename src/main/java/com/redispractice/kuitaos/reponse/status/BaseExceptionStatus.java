...
public enum BaseExceptionStatus implements ResponseStatus{
    ...
    ID_DUPLICATE(2005, HttpStatus.BAD_REQUEST.value(), "중복된 아이디 입니다."),
    USER_INFO_EMPTY(2006, HttpStatus.BAD_REQUEST.value(), "빈 값이 존재합니다."),
    ...
    OVERLAP_EMAIL_AUTH(6011, HttpStatus.BAD_REQUEST.value(), "이미 이메일 인증을 수행했습니다."),
